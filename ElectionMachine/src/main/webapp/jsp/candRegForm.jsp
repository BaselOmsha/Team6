		...
		<div class="box">
			...
			<form method='post' action='/candidate'>
				<table>
					<tr>
						<td>First name*</td>
						<td><input type='text' name='fname' placeholder='First name*'><br></td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
					...
					<tr>
						<td>Age</td>
						<td><input type='number' name='age' placeholder='Age*'><br></td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
				...
				<br> <br> <input type='submit' name='ok' value='Register'
			...
			<br> Items with an asterisk (*) are mandatory <br>
			<br>
		</div>
	</main>
