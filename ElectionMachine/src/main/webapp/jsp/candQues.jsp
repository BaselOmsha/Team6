	...
	<div id="wrapper">
		...
		<main>
            ...
            <ol>
                ...
                <li>${KYSYMYS.id}: ${fish.breed} ${fish.length} ${fish.weight} <a href='/rest/fishservice/delete/${fish.id}'>delete</a>
                <a href='/rest/fishservice/readtoupdate?id/${fish.id}'>edit</a>
                </c:forEach>
            </ol>
        </table>
					<table>
