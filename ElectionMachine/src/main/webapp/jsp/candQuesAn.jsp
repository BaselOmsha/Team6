	...
	<div id="wrapper">
		...
		<main>
 			...
 			<div class="box"> 
						...
						<h1 style="color:green">Your answers have been saved. Thank you!</h1><br> 
 			...
 			<table> 
					...
					<c:forEach var="Kysymyslista"
						...
						<td>${Kysymyslista.kysymys}</td>
 						<td><input type="radio" id="q1${Kysymyslista.kysymys_id}" name="kysymys${Kysymyslista.kysymys_id}" value="1" readonly> 
  							<label for="q1${Kysymyslista.kysymys_id}">1</label><br></td> 
   							<td><input type="radio" id="q2${Kysymyslista.kysymys_id}" name="kysymys${Kysymyslista.kysymys_id}" value="2" readonly> 
  							<label for="q2${Kysymyslista.kysymys_id}">2</label><br></td>
   							<td><input type="radio" id="q3${Kysymyslista.kysymys_id}" name="kysymys${Kysymyslista.kysymys_id}" value="3" readonly> 
   							<label for="q3${Kysymyslista.kysymys_id}">3</label><br></td> 
  							<td><input type="radio" id="q4${Kysymyslista.kysymys_id}" name="kysymys${Kysymyslista.kysymys_id}" value="4" readonly> 
   							<label for="q4${Kysymyslista.kysymys_id}">4</label><br></td> 
   							<td><input type="radio" id="q5${Kysymyslista.kysymys_id}" name="kysymys${Kysymyslista.kysymys_id}" value="5" readonly> 
