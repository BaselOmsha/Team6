...
<body>
			...
			<div class="container-fluid">
				...
				<div id="navbarNav">
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a class="nav-link active"
							href="jsp/candregForm.jsp" style="font-size: 20px"><b>Candidate
									Registration</b></a></li>
						<li class="nav-item"><a class="nav-link active"
		...
		<br><br>
			<h1>Candidate Registration Form</h1><br>
				<h5 style="color:green">Registration succeed. Candidates may log in from the candidate login page</h5>
