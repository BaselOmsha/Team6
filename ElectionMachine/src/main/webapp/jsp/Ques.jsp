	...
	<div id="wrapper">
		...
		<main>
 			...
 			<table> 
 				<tr>
 					<td>Ehdokas ID</td>
						<td><input type='text' name='ehdokas_id' value="${sessionScope.LoggedUser.candidate_id}" reaadonly><br></td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
						...
						<td>${Kysymyslista.kysymys}</td>
 						<td><input type="radio" id="q1${Kysymyslista.kysymys_id}" name="kysymys${Kysymyslista.kysymys_id}" value="1"> 
  							...
  							<td><input type="radio" id="q4${Kysymyslista.kysymys_id}" name="kysymys${Kysymyslista.kysymys_id}" value="4"> 
   							...
   							<td><input type="text" id="q5${Kysymyslista.kysymys_id}" name="kysymys${Kysymyslista.kysymys_id}" value="Add an Explanation">
 							<td></td> 
 							<td></td> 
 							<td></td> 
							<td></td> 
					...
					<td><a style=" font-size: 30px; border: solid black;" href="/deleteCand?candidate_id=${candidate.candidate_id }">Edit</a></td>
 					</tr> 
					</table> 
					</form>	
				</div>
